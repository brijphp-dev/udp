...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-4 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url( {{ asset('media/error/bg3.jpg') }});">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-row-fluid align-items-center align-items-md-start justify-content-md-center text-center text-md-left px-10 px-md-30 py-10 py-md-0 line-height-xs">
            ...
            <p class="error-subtitle text-success font-weight-boldest mb-10">How did you get here</p>
            <p class="font-size-h1 font-weight-boldest text-dark-75">@lang('userMessages.404_message1')</p>
            <p class="font-size-h4 line-height-md">@lang('userMessages.404_message2')</p>
