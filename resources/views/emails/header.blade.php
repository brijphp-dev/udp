            ...
            <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px;">
                <tr>
                    <td style="padding: 20px 0; text-align: center">
                        <img src="{{  url('asset/media/logos/logo-1.png')  }}" aria-hidden="true" width="200" alt="alt_text" border="0" style="height: auto; background: #f0f0f0; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                    </td>
                </tr>
            </table>
            <!-- Email Header : END -->