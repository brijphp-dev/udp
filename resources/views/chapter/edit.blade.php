    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Edit Chapter
                    <div class="text-muted pt-2 font-size-sm">Make changes to Chapter</div>
                </h3>
            </div>
        ...
        <div class="card-body">
            <form class="form" novalidate="novalidate" id="udp_chapter_add" method="POST" action="{{ route('chapter.edit.action', [encode_url($editChapter->id)]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label class="col-lg-12">Chapter Name <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-md-9 col-sm-12">
                        <input type="text" class="form-control font-size-h6" name="chapter_name" placeholder="Chapter *" value="{{ $editChapter->chapter_name }}" required/>
                        @error('chapter_name')
