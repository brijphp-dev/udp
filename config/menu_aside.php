...
return [
    ...
    'items' => [
        ...
        [
            ...
            'needPermission' => ['admin.dashboard'],
            'isRoute' => true,
            'new-tab' => false,
        ],
        [
        ...
        [
            ...
            'bullet' => 'line',
            'root' => true,
            'needPermission' => ['admin.mail.notification.form', 'chapter.index', 'chapter.create.form'],
            'isActive' => ['admin/notification*'],
            'page' => 'admin.mail.notification.form',
            'isRoute' => true,
        ],
        [
            ...
            'bullet' => 'line',
            'root' => true,
            'isActive' => ['admin/role*', 'admin/system_user*', 'admin/chapter*'],
            'needPermission' => ['role.index', 'systemuser.index', 'chapter.index'],
            'submenu' => [
                [  
                    'title' => 'Role Management',
                    'page' => 'role.index',
                    'isRoute' => true,
                    'needPermission' => ['role.index'],
                ],
                [   
                    'title' => 'System Users',
                    'page' => 'systemuser.index',
                    'isRoute' => true,
                    'needPermission' => ['systemuser.index'],
                ],
                [   
                    'title' => 'Chapter Management',
                    'page' => 'chapter.index',
                    'isRoute' => true,
                    'needPermission' => ['chapter.index'],
                ],
            ],
        ],
        [
            ...
            'bullet' => 'line',
            'root' => true,
            'isActive' => ['admin/user*', 'admin/voter*'],
            'needPermission' => ['admin.user.list', 'voter.index'],
            'submenu' => [
                [
                    'title' => 'Members List',
